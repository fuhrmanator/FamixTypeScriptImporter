...
describe('Tests for functions in function', () => {
    ...
    const theFunction2 = fmxRep._getFamixFunction("{functionsInFunction.ts}.fct.Block(1:16).fct2");
    const theFunction3 = fmxRep._getFamixFunction("{functionsInFunction.ts}.fct.Block(1:16).fct2.Block(2:21).fct3");
