...
describe('Tests for parameter with decorators', () => {
    ...
    const theParam = (Array.from(fmxRep._getFamixMethod("{parameterWithDecorators.ts}.BugReport2.print[MethodDeclaration]")?.parameters as Set<Parameter>) as Array<Parameter>).find((f) => f.getName() === "verbose");
