...
export class EntityDictionary {
     ...
     */
    public createFamixConcretisation(conEntity : Famix.ParametricClass | Famix.ParametricInterface ,genEntity : Famix.ParametricClass | Famix.ParametricInterface): Famix.Concretisation {
